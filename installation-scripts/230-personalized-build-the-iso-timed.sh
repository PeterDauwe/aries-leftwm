...
echo
	...
	AriesVersion='v'$(date +%y).$(date +%m).$(date +%d)
	isoLabel='aries-'$desktop'-'$AriesVersion'-x86_64.iso'

	# setting of the general parameters
	archisoRequiredVersion="archiso 61-1"
	buildFolder=$HOME"/Aries-build"
	outFolder=$HOME"/Aries-Out"
...
############################################################################
	echo
	echo "Adding the content of the personal-aries folder"
	echo
	cp -rf ../personal-aries/ ../work/archiso/airootfs/
    
	if test -f ../work/archiso/airootfs/personal-aries/.gitkeep ; then
		echo
		rm ../work/archiso/airootfs/personal-aries/.gitkeep
		echo ".gitkeep is now removed"
		echo
    fi
############################################################################
...
echo
	...
	newname1='iso_name="aries-'$desktop

	oldname2='iso_label="arcolinuxl'
	newname2='iso_label="aries-'$desktop

	oldname2b='iso_version="'$arcolinuxVersion
	newname2b='iso_version="'$AriesVersion

	oldname3='ArcoLinuxL'
	newname3='Aries-'$desktop

	oldname3b='ISO_RELEASE='$arcolinuxVersion
	newname3b='ISO_RELEASE='$AriesVersion

	#hostname
	oldname4='ArcoLinuxL'
	newname4='Aries-'$desktop
